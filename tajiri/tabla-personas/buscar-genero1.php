...
<form action="buscar-genero2.php" method="post">
<h2>Enter the name of the genre to search</h2>
  <table>
    <tr>
      <td>Genre:</td>
      <td><input type="text" name="genero" autofocus></td>
    </tr>
  </table>
  <p>
